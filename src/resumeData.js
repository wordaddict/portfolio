let resumeData = {
  ...
  "linkedinId":"adeyinka-micheal-207986125/",
  "email1":"adeyinkamichealola@gmail.com",
  ...
  "socialLinks":[
      {
        "id":1,
        "name":"linkedin",
        "url":"https://www.linkedin.com/in/adeyinka-micheal-207986125/",
        "className":"fa fa-linkedin"
      },
      {
        "id":2,
        "name":"github",
        "url":"http://github.com/wordaddict",
        "className":"fa fa-github"
      },
      {
        "id":3,
        "name":"skype",
        "url":"http://skype.com/madeyinka6",
        "className":"fa fa-skype"
      },
      {
        "id":4,
        "name":"Twitter",
        "url":"http://twitter.com/olamicheal_",
  ...
  "skills":[
    ...
    {
      "id":4,
      "name":"Python(Flask, webpy, Lambda functions)",
      "skillname": "python"
    },
    {
      "id":5,
    ...
    {
      "id":6,
      "name":"Queuing systems (RabbitMQ)",
      "skillname": "queue"
    },
    {
      "id":7,
      "skillname": "cloud",
      "name":"Cloud services - AWS (S3, lambda functions, Athena, Kinesis firehose)"
    },
    {
      "id":8,
      "skillname": "ci",
    ...
    },
    {
      "id":9,
      "skillname": "test",
      "name":"Testing & Environment (Mocha & Chai/ Linux Env)"
    }
  ],
  "portfolio":[
    {
      ...
      "description":"A web chat application written in React, redux and Node",
  ...
  "testimonials":[
    {
      "id":1,
      "description":"Adeyinka Micheal is a very self driven reliable engineer. He’s got a lot of grit. Ships great code fast. Knowledgeable and dependent!",
      "name":"Ohans Emmanuel (Senior Frontend Engineer)"
    },
    {
      "id":2,
      "description":"Talk about a Software Engineer that has a mix of good attitude, empathy, and awesome problem-solving skill, ADEYINKA Micheal is an embodiment of these attributes. I have had the pleasure of working with him on various small scale and large scale projects and I can confidently recommend his passion for crafting software solutions, it is just amazing!. I absolutely won't forget to add that no matter how tense a day is, Micheal made sure everyone left with a smile. I am certain Micheal would be an asset to any team",
      "name":"EMEHINOLA Idowu Ololade (DevOps/SRE at Terragon Group)"
    },
    {
      "id":3,
